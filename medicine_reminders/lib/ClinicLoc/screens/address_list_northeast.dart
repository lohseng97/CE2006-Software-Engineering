...
/// The AddressListNorthEast class shows the available CHAS Clinics in the Northeastern Region of Singapore.
///
...
class AddressListNorthEast extends StatelessWidget {
  //static const String routeName = '/list-address-south';
  final Color colorSel = Colors.pinkAccent.shade200;
  final List<List<Object>> items =
      ClinicDatabaseInterface.addrDataSingleton.getNorthEastData;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Address List - North-East')),
      drawer: MainDrawer(),
